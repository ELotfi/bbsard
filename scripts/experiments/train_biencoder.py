...
class BiEncoderTrainer(object):
    def __init__(self, 
                 ...
                 seed: int = 42,
                 use_amp: bool = False,
                 output_path: str = "/home/ubuntu/projects/bsard/outputs"):
        # Init trainer modules and parameters.
        self.model = model
        self.loss_fn = loss_fn
        self.batch_size = batch_size
        self.epochs = epochs
        self.save_after = epochs - 10
    ...
    def fit(self):
        ...
        for epoch in tqdm(range(self.epochs),  desc="Epoch"):
            ...
            # Save the model.
            if   self.epochs - epoch<10:#(epoch > 0) and (epoch%4==0):
...
if __name__ == '__main__':
    ...
    model = BiEncoder(is_siamese=True,
                      q_model_name_or_path= 'FremyCompany/olm-bert-oscar-nl-step4',#'GroNLP/bert-base-dutch-cased',#'DTAI-KULeuven/robbert-2023-dutch-base',# 'camembert/camembert-large', #'flaubert/flaubert_base_cased',
                      truncation=True,
                      max_input_len=1000,
                      chunk_size=200,
                      window_size=20,
    ...
    trainer = BiEncoderTrainer(model=model, 
                               ...
                               queries_filepath= "/home/ubuntu/projects/bsard/data/dutch/du_train_T0_filtered.csv" ,#abspath(join(__file__, "../../../data/bsard_v1questions_fr_train.csv")),
                               documents_filepath= "/home/ubuntu/projects/bsard/data/dutch/du_articles_new_filtered.csv" ,#abspath(join(__file__, "../../../data/bsard_v1/articles_fr.csv")),
